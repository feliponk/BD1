<%-- 
    Document   : edit_prod
    Created on : 24-abr-2014, 0:56:15
    Author     : felipe
--%>
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <article class="grid_8">
                                            <div class="indent-left2">
                                                <h3 class="p1">Editar Producto</h3>
                                                <%
            Connection cn = null;
                               ...
                               " <table class=\"price-list\">"+
                                    "<tbody>"+
                                        "<tr>"+
                                            "<td>Codigo</td>"+
                                            "<td>"+s_codigo+"</td>"+
                                            "<input type=\"hidden\" name=\"f_cod\" value="+s_codigo+" />"+
                                        "</tr>"+
                                        "<tr>"+
                                            "<td>Nombre</td>"+
                                            "<td>"+nombre+"</td>"+
                                        ...
                                        "<tr>"+
                                            "<td>Precio</td>"+
                                            "<td><input type=\"text\" name=\"f_precio\" value="+precio+" onChange=\"validarSiNumero(this.value);\" /></td>"+
                                        ...
                                        "<tr>"+
                                            "<td>&nbsp;</td>"+
                                            "<td><input class=\"button\" type=\"submit\" value=\"Guardar cambios\" /></td>"+
                                        "</tr>"+
                                    "</tbody>"+
                                 "</table>"+
                             "</form>");
