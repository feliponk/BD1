<%-- 
    ...
    Created on : 25-abr-2014, 13:44:54
    Author     : felipe
--%>
	...
	<div class="main-bg">
        <div class="bg">
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <article class="grid_8">
                                            <div class="indent-left2">
                                                <h3 class="p1">Seleccione cliente</h3>
            <%
            Connection cn = null;
            ...
            try
            {
                ...
                out.println("<form action= \"ver_venta_cliente2.jsp\" method=\"POST\" >"+
                ...
                out.println(        "</select></td>"+
                                ...
                                "<tr>"+
                                    "<td>&nbsp;</td>"+
                                    "<td><input class=\"button\" type=\"submit\" value=\"Ver\" /></td>"+
                                "</tr>"+
                            "</tbody>"+
                        "</table>"+
                        "</form>");
