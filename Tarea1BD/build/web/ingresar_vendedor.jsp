<%-- 
    ...
    Created on : 18-abr-2014, 22:04:00
    Author     : felipe
--%>
...
<html>
	...
	<div class="main-bg">
                ...
                <div class="main">
                    ...
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a class="active" href="ingresar_vendedor.jsp">Ingresar Vendedor</a></li>
       ...
       <div class="indent-left">
        <h3 class="p1">Ingresar vendedor</h3>
        <form action="guardar_vendedor.jsp" method="POST">
            <table class="price-list">
                 
                <tbody>
                    <tr>
                        <td>Rut</td>
                        <td><input type="text" name="f_rut" value="" /></td>
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="f_clave2"  value=""/></td>
                    </tr>
