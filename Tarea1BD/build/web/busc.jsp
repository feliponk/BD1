<%-- 
    Document   : busc
    Created on : 24-abr-2014, 22:36:24
    Author     : felipe
--%>
...
;            try
            {
                ...
                while (rs2.next())
                {
                codigo2 = rs2.getString("ID_PRODUCTO");
                ...
                out.println("<form action= \"edit_prod.jsp\" method=\"POST\" >"+
                                        ...
                                        "<tr>"+
                                            ...
                                            "<td><input class=\"button\" type=\"submit\" value=\"Editar\" /></td>"+
                                            "<input type=\"hidden\" name=\"f_cod\" value="+codigo2+" />"+
                ...
                out.println("</tbody>"
                        + "</table>");
                if (codigo2.compareTo("")== 0 && codigo.compareTo("") == 0)
                {
                    out.println("<script>alert('No hay resultados')</script>"); 
