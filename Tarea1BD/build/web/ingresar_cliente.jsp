<%-- 
    ...
    Created on : 19-abr-2014, 0:19:07
    Author     : felipe
--%>
        ...
        <div class="bg">
            ...
            <header>
                <div class="main">
                    ...
                    <nav>
                        <ul class="menu">
                            <li><a href="menu_vendedor.jsp">Home</a></li>
                            <li><a class="active" href="ingresar_cliente.jsp">Ingresar Cliente</a></li>
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <article class="grid_8">
                                            <div class="indent-left2">
                                                <h3 class="p1">Ingresar Cliente</h3>
