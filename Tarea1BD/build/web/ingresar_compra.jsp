<%-- 
    ...
    Created on : 19-abr-2014, 18:30:02
    Author     : felipe
--%>
...
<html>
	...
	<div class="main-bg">
                ...
                <div class="main">
                    ...
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a class="active" href="ingresar_compra.jsp">Ingresar compra</a></li>
       ...
       <div class="indent-left">
        <h3 class="p1">Ingresar compra</h3>
        <form action="guardar_compra.jsp" method="POST">
