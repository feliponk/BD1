<%-- 
    Document   : ver_venta_cliente
    Created on : 21-abr-2014, 20:22:12
    Author     : felipe
--%>
	...
	<div class="main-bg">
                ...
                <div class="main">
                    ...
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a class="active" href="ver_venta_cliente.jsp">Ver Ventas a Cliente</a></li>
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <article class="grid_8">
                                            <div class="indent-left2">
                                                <h3 class="p1">Ventas asociadas al cliente</h3>
        ...
        <%
            ...
            try
            {
                ...
                ResultSet rs = st.executeQuery("select * from \"CLIENTE\" where \"NOMBRE\" = '"+cliente+"'");
                while (rs.next())
                {
                ...
                ResultSet rs2 = st2.executeQuery("select * from \"view_VentasCliente\" where \"ID_CLIENTE\" = '"+rut+"'");
                out.println("<form action= \"menu_1.jsp\" method=\"POST\" >"+
                ...
                {
                    out.println("<script>alert('El cliente no tiene ninguna venta asociada')</script>");
