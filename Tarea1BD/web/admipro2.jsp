<%-- 
    Document   : admipro2
    Created on : 23-abr-2014, 0:54:13
    Author     : felipe
--%>
...
<body id="page5">
	<div class="main-bg">
        <div class="bg">
                ...
                <div class="main">
                    ...
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a class="active" href="admipro2.jsp">Administrar Producto </a></li>
                            <li><a href="ingresar_compra.jsp">Ingresar compra</a></li>
                            <li><a href="ver_venta_cliente.jsp">Ver Ventas a Cliente</a></li>
                            <li><a href="ingresar_venta2.jsp">Ingresar Venta</a></li>
                        </ul>
                    </nav>
                </div>
            </header>
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <article class="grid_8">
                                            <div class="indent-left2">
                                                <h3 class="p1">Lista de productos</h3>
                                                <%
            Connection cn = null;
            ...
            String nombre;
            String cantidad;
            out.println("<table class=\"price-list\">"
                    + "<thead>"+
                           "<tr>"+
                              "<td>Codigo</td>"+
                              "<td>Nombre</td>"+
                              ...
                              "<td><a href=\"admipro2.jsp\">Actualizar Lista</a></td>"+
                           "</tr>"+
                     "</thead>"
                    + "<tbody>");
;            try
            {
                ...
                out.println("<form action= \"edit_prod.jsp\" method=\"POST\" >"+
                                        ...
                                        "<tr>"+
                                            ...
                                            "<td><input class=\"button\" type=\"submit\" value=\"Editar\" /></td>"+
                                            "<input type=\"hidden\" name=\"f_cod\" value="+codigo+" />"+
                ...
                session.setAttribute("f_codigo", codigo);
                out.println("</tbody>"
                        + "</table>");
            }
            catch (Exception e) {
                out.print("<br>Hubo un error de tipo: " + e);
                } finally 
                    {
                     if (cn != null) {
                try {
        ...
        %>
                                        ...
                                        <article class="grid_4">
                                            <div class="indent-left2">
                                                <h3 class="p1">Buscar</h3>
                                                Por nombre o categoria
                                                <form  action="busc.jsp" method="post" >                    
                                                    <table >
                                                        <tbody>
                                                        <tr>
                                                            <td><input name="f_buscador" type="text" /></td>
                                            ...
                                            <div class="indent-left2">
                                                <h3 class="p1">Agregar producto</h3>
                                                <form action="guardar_producto.jsp" method ="POST" >
                                                    <table class="price-list">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Cantidad</td>
                                                                <td><input type="text" name="f_cantidad" value ="" onChange="validarSiNumero(this.value);" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Precio</td>
                                                                <td><input type="text" name="f_precio" value ="" onChange="validarSiNumero(this.value);" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>&nbsp;</td>
